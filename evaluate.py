...
ALT_H5    = "vgg16_transfer_learning.h5"      # opcional, por si quieres comparar
...
out.to_csv("eval_resultados_test.csv", index=False)
print("\nResultados guardados en: eval_resultados_test.csv")
